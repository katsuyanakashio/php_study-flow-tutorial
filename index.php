...
//DB接続
try {
    $pdo = new PDO('mysql:host=localhost;dbname=bbs-app', 'root', '2456vic33');
...
if (!empty($_POST["submitButton"])) {
    ...
    if (empty($error_message)) {
        ...
        try {
            ...
            //SQL作成
            $statment = $pdo->prepare("INSERT INTO `bbs-table` (username, comment, postData) VALUES (:username, :comment, :postDate)");
...
//DBからコメントデータを取得するにはphpmyadminのSQLSELECTからコピペ
...
<head>
    ...
    <title>PHP災害伝言アプリ</title>
    <link rel="stylesheet" href="style.css">
</head>

<body>
    
    <h1 class="title">PHP災害伝言アプリ</h1>
    <hr>
